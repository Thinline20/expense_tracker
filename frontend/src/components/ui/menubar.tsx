...
const MenubarMenu: Component<ComponentProps<typeof MenubarPrimitive.Menu>> = (
  props,
) => {
...
const MenubarItemLabel: Component<
  ComponentProps<typeof MenubarPrimitive.ItemLabel> & { inset?: boolean }
> = (props) => {
  const [, rest] = splitProps(props, ["class", "inset"]);
  return (
