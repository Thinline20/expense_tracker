...
const Pagination: Component<ComponentProps<typeof PaginationPrimitive>> = (
  props,
) => {
...
type PreviousProps = Exclude<
  ComponentProps<typeof PaginationPrimitive.Previous>,
  "children"
>;
...
type NextProps = Exclude<
  ComponentProps<typeof PaginationPrimitive.Next>,
  "children"
>;
