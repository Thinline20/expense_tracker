...
const RadioGroup: Component<ComponentProps<typeof RadioGroupPrimitive>> = (
  props,
) => {
  const [, rest] = splitProps(props, ["class"]);
  return (
    <RadioGroupPrimitive class={cn("grid gap-2", props.class)} {...rest} />
  );
};
...
const RadioGroupItemLabel: Component<
  ComponentProps<typeof RadioGroupPrimitive.ItemLabel>
> = (props) => {
  const [, rest] = splitProps(props, ["class"]);
  return (
