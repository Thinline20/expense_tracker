...
const SheetOverlay: Component<ComponentProps<typeof SheetPrimitive.Overlay>> = (
  props,
) => {
...
export type DialogContentProps = ComponentProps<typeof SheetPrimitive.Content> &
...
const SheetTitle: Component<ComponentProps<typeof SheetPrimitive.Title>> = (
  props,
) => {
  const [, rest] = splitProps(props, ["class"]);
  return (
